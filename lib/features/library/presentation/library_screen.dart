                      ...
                      child: DataTable(
                        ...
                        columns: [
                          DataColumn(
                            ...
                            onSort: (_, __) =>
                                _setSort(LibrarySortField.name),
                          ),
                          DataColumn(
                            label: const Text('Authors'),
                            onSort: (_, __) =>
                                _setSort(LibrarySortField.authors),
                          ),
                          DataColumn(
                            label: const Text('Added'),
                            onSort: (_, __) =>
                                _setSort(LibrarySortField.addedAt),
                          ),
                          DataColumn(
                          ...
                          DataColumn(
                            ...
                            onSort: (_, __) =>
                                _setSort(LibrarySortField.subject),
                          ),
                        ],
                        rows: [
                          for (final document in documents)
                            DataRow(
                              ...
                              cells: [
                                ...
                                DataCell(
                                  Text(_formatDateTime(document.addedAt)),
                                ),
                                DataCell(
                                  Text(
                                    _formatDateTime(
                                      document.fileLastModifiedAt,
                                    ),
                                  ),
                                ),
